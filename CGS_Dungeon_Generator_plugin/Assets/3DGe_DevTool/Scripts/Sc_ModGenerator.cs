...
public class Sc_ModGenerator : MonoBehaviour
{
    ...
    // Allows further control over the edge types
    [Header("Edge Types")]
    ...
    private string m_VariantPath = "Assets/3DGe_DevTool/Modules/Variants/";
    ...
    void CreateVariant(Sc_Module mod)
    {
        ...
        for (int i = 1; i < 4; i++)
        {
            ...
            UnityEditor.AssetDatabase.CreateAsset(newModule, $"{m_VariantPath}{MOD}_{rot}.asset");
    ...
    public void DeleteAllVariantsInFolder()
    {
        ...
        if (DELETE)
        {
            ...
            string[] variantFolder = { m_VariantPath };
